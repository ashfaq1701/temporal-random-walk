...
namespace edge_data {
    ...
    HOST DEVICE inline size_t size(const EdgeDataStore *edge_data) {
        return edge_data->timestamps_size;
    }

    HOST inline void set_size(EdgeDataStore* edge_data, const size_t size) {
    ...
    HOST inline void add_edges(EdgeDataStore *edge_data, const int *sources, const int *targets, const int64_t *timestamps, const size_t size) {
    ...
    HOST inline DataBlock<Edge> get_edges(const EdgeDataStore *edge_data) {
    ...
    HOST inline DataBlock<int> get_active_node_ids(const EdgeDataStore* edge_data) {
    ...
    HOST inline size_t active_node_count(const EdgeDataStore* edge_data) {
        size_t count = 0;
    ...
    HOST inline void populate_active_nodes_std(EdgeDataStore* edge_data) {
    ...
    HOST inline void update_temporal_weights_std(EdgeDataStore *edge_data, const double timescale_bound) {
    ...
    HOST inline void populate_active_nodes_cuda(EdgeDataStore* edge_data) {
        const size_t num_edges = size(edge_data);
        if (num_edges == 0) {
            return;
        }
    ...
    HOST inline void update_timestamp_groups_cuda(EdgeDataStore *edge_data) {
        if (edge_data->timestamps_size == 0) {
    ...
    HOST inline void update_temporal_weights_cuda(EdgeDataStore *edge_data, double timescale_bound) {
        if (edge_data->timestamps_size == 0) {
    ...
    HOST inline EdgeDataStore *to_device_ptr(const EdgeDataStore *edge_data) {
