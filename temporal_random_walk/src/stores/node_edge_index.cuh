...
namespace node_edge_index {
     ...
     * Common Functions
     */
    HOST inline void clear(NodeEdgeIndexStore* node_edge_index) {
    ...
    HOST DEVICE inline SizeRange get_edge_range(const NodeEdgeIndexStore* node_edge_index, const int dense_node_id, const bool forward, const bool is_directed) {
        if (is_directed) {
    ...
    HOST DEVICE inline SizeRange get_timestamp_group_range(const NodeEdgeIndexStore* node_edge_index, const int dense_node_id, const size_t group_idx, const bool forward, const bool is_directed) {
    ...
    HOST DEVICE inline MemoryView<size_t> get_timestamp_offset_vector(const NodeEdgeIndexStore* node_edge_index, const bool forward, const bool is_directed) {
        if (is_directed && !forward) {
    ...
    HOST DEVICE inline size_t get_timestamp_group_count(const NodeEdgeIndexStore* node_edge_index, const int dense_node_id, const bool forward, const bool is_directed) {
    ...
    HOST inline void allocate_node_edge_offsets(NodeEdgeIndexStore* node_edge_index, const size_t node_index_capacity, const bool is_directed) {
    ...
    HOST inline void allocate_node_edge_indices(NodeEdgeIndexStore* node_edge_index, const bool is_directed) {
    ...
    HOST inline void allocate_node_timestamp_indices(NodeEdgeIndexStore* node_edge_index, const bool is_directed) {
     ...
     * Std implementations
     */
    HOST inline void compute_node_edge_offsets_std(
        ...
        for (size_t i = 0; i < edge_data->timestamps_size; i++) {
            const int src_idx = edge_data->sources[i];
            const int tgt_idx = edge_data->targets[i];
    ...
    HOST inline void compute_node_edge_indices_std(
        NodeEdgeIndexStore* node_edge_index,
        const EdgeDataStore* edge_data,
    ...
    HOST inline void compute_node_timestamp_offsets_std(
        NodeEdgeIndexStore *node_edge_index,
        const EdgeDataStore *edge_data,
        ...
        auto *outbound_group_count = new size_t[node_count](); // Initialize to zeros
        size_t *inbound_group_count = nullptr;

        if (is_directed) {
            inbound_group_count = new size_t[node_count](); // Initialize to zeros
        }
    ...
    HOST inline void compute_node_timestamp_indices_std(
        NodeEdgeIndexStore *node_edge_index,
        const EdgeDataStore *edge_data,
    ...
    HOST inline void update_temporal_weights_std(NodeEdgeIndexStore *node_edge_index, const EdgeDataStore *edge_data,
    ...
    HOST inline void compute_node_edge_offsets_cuda(
        NodeEdgeIndexStore *node_edge_index,
        const EdgeDataStore *edge_data,
        bool is_directed
    ) {
    ...
    HOST inline void compute_node_edge_indices_cuda(
        NodeEdgeIndexStore *node_edge_index,
        const EdgeDataStore *edge_data,
        EdgeWithEndpointType *outbound_edge_indices_buffer,
        bool is_directed
    ...
    HOST inline void compute_node_timestamp_offsets_cuda(
        NodeEdgeIndexStore *node_edge_index,
        const EdgeDataStore *edge_data,
        const size_t node_count,
        bool is_directed
    ...
    HOST inline void compute_node_timestamp_indices_cuda(
        NodeEdgeIndexStore *node_edge_index,
        const EdgeDataStore *edge_data,
        const size_t node_index_capacity,
        bool is_directed
    ...
    HOST inline void update_temporal_weights_cuda(
        NodeEdgeIndexStore *node_edge_index,
        const EdgeDataStore *edge_data,
    ...
    HOST inline NodeEdgeIndexStore* to_device_ptr(const NodeEdgeIndexStore *node_edge_index) {
    ...
    HOST inline void rebuild(NodeEdgeIndexStore *node_edge_index, const EdgeDataStore *edge_data, const bool is_directed) {
        // Get sizes
        const size_t num_edges = edge_data->timestamps_size;
