...
HOST inline curandState* get_cuda_rand_states(size_t grid_dim, size_t block_dim) {
...
HOST inline std::pair<size_t, size_t> get_optimal_launch_params(const size_t data_size, const cudaDeviceProp* device_prop) {
