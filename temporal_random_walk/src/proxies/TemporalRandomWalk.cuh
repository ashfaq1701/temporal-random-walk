...
__global__ inline void get_edge_count_kernel(size_t* result, const TemporalRandomWalkStore* temporal_random_walk) {
...
public:
    explicit TemporalRandomWalk(
        ...
        const double timescale_bound=DEFAULT_TIMESCALE_BOUND): use_gpu(use_gpu) {
