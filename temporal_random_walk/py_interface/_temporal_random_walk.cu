...
PYBIND11_MODULE(_temporal_random_walk, m)
{
    py::class_<TemporalRandomWalk>(m, "TemporalRandomWalk")
        .def(py::init([](
                         ...
                         const std::optional<double> spatiotemporal_alpha,
                         const std::optional<double> spatiotemporal_beta,
                         const std::optional<double> spatiotemporal_gamma,
                         ...
                         const std::optional<bool> shuffle_walk_order)
             {
                 return std::make_unique<TemporalRandomWalk>(
                     ...
                     spatiotemporal_alpha.value_or(DEFAULT_SPATIOTEMPORAL_ALPHA),
                     spatiotemporal_beta.value_or(DEFAULT_SPATIOTEMPORAL_BETA),
                     spatiotemporal_gamma.value_or(DEFAULT_SPATIOTEMPORAL_GAMMA),
             ...
             py::arg("spatiotemporal_alpha") = py::none(),
             py::arg("spatiotemporal_beta") = py::none(),
             py::arg("spatiotemporal_gamma") = py::none(),
