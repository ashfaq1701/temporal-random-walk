...
PYBIND11_MODULE(_temporal_random_walk, m) {
    py::class_<TemporalRandomWalk>(m, "TemporalRandomWalk")
        .def(py::init<bool, bool, int64_t, bool, double, int>(),
            R"(
            ...
            max_time_capacity (int): Maximum time window for edges. Edges older than (latest_time - max_time_capacity) are removed. Use -1 for no limit.
            enable_weight_computation (bool): Enable CTDNE weight computation. Required for ExponentialWeight picker.
            timescale_bound (float): Scale factor for temporal differences. Used to prevent numerical issues with large time differences.
            node_count_max_bound (int): Maximum node count in the graph. Setting this to a realistically higher bound can help save memory.
            )",
            py::arg("is_directed"),
            py::arg("use_gpu") = false,
            py::arg("max_time_capacity") = -1,
            py::arg("enable_weight_computation") = false,
            py::arg("timescale_bound") = DEFAULT_TIMESCALE_BOUND,
            py::arg("node_count_max_bound") = DEFAULT_NODE_COUNT_MAX_BOUND)
        .def("add_multiple_edges",
            [](TemporalRandomWalk &tw, const std::vector<std::tuple<int, int, int64_t> > &edge_infos) {
            ...
            py::arg("edge_infos"))
        .def("get_random_walks_for_all_nodes",
            [](TemporalRandomWalk &tw, const int max_walk_len, const std::string &walk_bias,
                const int num_walks_per_node, const std::string &initial_edge_bias = "",
            ...
            py::arg("initial_edge_bias") = "",
            py::arg("walk_direction") = "Forward_In_Time")

        .def("get_random_walks_and_times_for_all_nodes",
            [](TemporalRandomWalk &tw, const int max_walk_len, const std::string &walk_bias,
                const int num_walks_per_node, const std::string &initial_edge_bias = "",
                const std::string &walk_direction = "Forward_In_Time") {
        ...
        .def("get_random_walks",
            [](TemporalRandomWalk &tw, const int max_walk_len, const std::string &walk_bias,
                const int num_walks_total, const std::string &initial_edge_bias = "",
                const std::string &walk_direction = "Forward_In_Time") {
        ...
        .def("get_random_walks_and_times",
            [](TemporalRandomWalk &tw, const int max_walk_len, const std::string &walk_bias,
                const int num_walks_total, const std::string &initial_edge_bias = "",
                const std::string &walk_direction = "Forward_In_Time") {
        ...
        .def("add_edges_from_networkx",
            [](TemporalRandomWalk &tw, const py::object &nx_graph) {
    ...
    py::class_<WeightBasedRandomPicker>(m, "WeightBasedRandomPicker")
        ...
        .def("pick_random",
            [](const WeightBasedRandomPicker &picker, const std::vector<double> &cumulative_weights,
