...
PYBIND11_MODULE(_temporal_random_walk, m)
{
    py::class_<TemporalRandomWalk>(m, "TemporalRandomWalk")
        .def(py::init([](const bool is_directed, bool use_gpu,
                        ...
                        std::optional<size_t> node_count_max_bound)
             {
            ...
            node_count_max_bound (size_t, optional): Max number of nodes in the graph. Defaults to 100,000.
            )",
             py::arg("is_directed"),
